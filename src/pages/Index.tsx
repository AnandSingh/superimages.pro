      ...
      <section className="container mx-auto px-4 lg:px-24 py-8 md:py-12 min-h-[95vh] flex items-center">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-12 items-center max-w-[1400px] mx-auto">
          ...
          duration: 0.6
            ...
            <a href="https://linktw.in/cfITPA" target="_blank" rel="noopener noreferrer">
              <Button size="lg" className="bg-[#25D366] hover:bg-[#25D366]/90 text-white font-semibold px-10 py-8 text-xl h-auto">
                Click Here to Chat
              </Button>
            </a>
          ...
          delay: 0.2
            ...
            <img src="https://s3.gifyu.com/images/bSkqc.gif" alt="WhatsApp AI Demo" className="w-full max-w-[1000px] md:max-w-[500px]" />
          </motion.div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 lg:px-24">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex justify-center md:justify-end">
              <img alt="Superb Logo" src="/lovable-uploads/95a69163-fc19-4829-a1f9-70e95ab9fe4d.png" className="h-48 object-contain" />
            </div>
          </div>
        </div>
      </footer>
